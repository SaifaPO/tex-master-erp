...
export default function DtfSeparatorTab() {
  ...
  return (
    <div className="space-y-6 text-slate-100">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold text-white flex items-center gap-2"><ImageIcon className="h-5 w-5 text-indigo-400" /> DTF/DTG Separátor <span className="text-xs text-slate-500 font-normal">— halftone/farebná separácia</span></h2>
