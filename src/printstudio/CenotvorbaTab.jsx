  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-lg p-4">
        ...
        <p className="text-[11px] text-emerald-500/80 mt-2">DPH sa odteraz nastavuje LEN tu — DTF/Textilná metráž, Zástava, Beachflag, Čelenky aj Buffky ju čítajú odtiaľto, nie zo svojich vlastných nastavení. Cena šitia sa používa v Katalógu Produktov na automatický dopočet Výrobnej ceny (minúty šitia × táto sadzba + réžia + potlač).</p>
